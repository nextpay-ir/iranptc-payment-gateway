<div class="zx-y-logged-page">
    ...
    <div class="zx-y-logged-page-top-two ui-widget-header zx-content-shadow">
        <div class="top-two-head">
            ...
            <div class="head-txt2">افزایش موجودی حساب سپرده از طریق حساب نکست پی، حساب بانکی، حساب لیبرتی رزرو یا حساب جاری سایت</div>
        </div>
    </div>
  ...
  <?php if(config('support_libertyreserve') == 1 || $xUS['id'] == 1){?>
      ...
      <?php } ?>
 <?php if(config('support_nextpay') == 1 || $xUS['id'] == 1){ ?>
 			<td width="10"></td>
		        <td>
				<div class="click-btn zr ui-helper-clearfix op-pointer">
					<div class="flo-l no-bold pad-5 ui-widget-header ui-corner-left">نکست پی</div>
					<div class="flo-r no-bold pad-5 ui-state-hover ui-corner-right" style="border-width:1px 1px 1px 0;">حداقل <?php echo config('min_nextpay'); ?>ت</div>
				</div>
			</td>
      <?php } ?>
...
?>  
	 <?php
if(config('support_nextpay') == 1 || $xUS['id'] == 1){
?>
	<div id="xmb-zr" class="xmb-box" align="center" style="display:none;">

		<div align="center" style="width:270px;margin:50px auto;"><span class="op-sha" style="font-size:17px;"><b>حساب نکست پی</b></span>
			<table width="100%" cellpadding="0" cellspacing="5" class="pad-10 op-box-shadow op-slider ui-widget-content ui-corner-tr ui-corner-bottom">
			<tr>
				<td align="center"><span id="amount-zr" class="pad-2-5 bold" style="font-size:18px;color:#228B22;cursor:default;"><?php echo config('min_nextpay'); ?> تومان</span></td>
			</tr>
			<tr>
...
<form method="POST" action="/?v=c&cc=order&pay=bank" id="form-zr" onsubmit="return false;" align="center">
   <input type="hidden" name="zr_amnt" value="<?php echo config('min_nextpay'); ?>">
   <input type="hidden" name="zr_comments" value="<?php echo $xUS['x_username']; ?>">
   <input type="image" src="/includes/img/button/nextpay.jpg" border="0" name="submit" alt="افزایش موجودی حساب با کارتهای عضو شبکه شتاب" />
</form>	
				</td>
			</tr>
			</table>
...
<div id="xmb-apx" class="xmb-box" align="center" style="display:none;">
		...
		<div align="center" style="width:270px;margin:50px auto;"><span class="op-sha" style="font-size:17px;"><b>پرداخت nextpay</b></span>
			<table width="100%" cellpadding="0" cellspacing="5" class="pad-10 op-box-shadow op-slider ui-widget-content ui-corner-tr ui-corner-bottom">
			<tr>
			...
			<tr>
				<td align="center" style="padding-top:10px;">	
<form method="POST" action="/nextpay/" id="form-apx" onsubmit="return false;" align="center">
   ...
   <input type="image" src="logo.gif" border="0" name="submit" alt="افزایش موجودی حساب با nextpay" />
</form>
				</td>
			</tr>
			</table>
...
$(function(){
	...
	$("#slider-zr").slider({range:"min",step:1000,value:<?php echo config('min_nextpay'); ?>,min:<?php echo config('min_nextpay'); ?>,max:350000,
	...
	var $confirm_zr = $('<div align="center"></div>')
		.html('افزایش موجودی حساب سپرده از طریق حساب <b>نکست پی</b>')
		.dialog({autoOpen:false,resizable:false,width:450,minHeight:0,modal:true,title:'شما مطمئن هستید؟',
			buttons:{
				خیر:function(){$(this).dialog('close');return false;},
...
var $confirm_pl = $('<div align="center"></div>')
		.html('افزایش موجودی حساب سپرده از طریق حساب <b>nextpay<b>')
		.dialog({autoOpen:false,resizable:false,width:450,minHeight:0,modal:true,title:'شما مطمئن هستید؟',
			buttons:{
				خیر:function(){$(this).dialog('close');return false;},
